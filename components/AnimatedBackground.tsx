...
export default function AnimatedBackground() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      gradient.addColorStop(1, 'rgb(8, 15, 30)');
      ctx.fillStyle = gradient;
      ctx.fillRect(0, 0, canvas.width, canvas.height);

      // Add subtle mesh gradient overlay
      const meshGradient = ctx.createLinearGradient(0, 0, canvas.width, canvas.height);
      meshGradient.addColorStop(0, 'rgba(99, 102, 241, 0.03)');
      meshGradient.addColorStop(0.5, 'rgba(168, 85, 247, 0.03)');
      meshGradient.addColorStop(1, 'rgba(59, 130, 246, 0.03)');
